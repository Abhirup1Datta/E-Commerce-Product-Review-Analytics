...
This project was part of my independent learning initiative where I wanted to apply NLP and machine learning to real-world data. I chose product reviews for Apple AirPods Pro because it’s a globally used product with a lot of user feedback available online. I scraped around 20,000 reviews from Walmart to analyze what customers actually feel about the product.
### Methodology:
